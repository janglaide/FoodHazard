...
namespace FoodHazardAnalysis.Logic.Entities
{
    public partial class FoodAppContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseNpgsql("Server=rajje.db.elephantsql.com;Database=csyuopgz;User Id=csyuopgz;Password=hAyhYvS_IG21vHMTp5kSCSxWAzgaaN6I;Port=5432");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductAdditives>(entity =>
            {
                ...
                entity.Property(e => e.EadditiveId).HasColumnName("EAdditiveId");
